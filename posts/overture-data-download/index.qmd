...
#   packages = c("duckdb", "matplotlib", "pandas", "geopandas", "shapely", "folium", "pathlib", "folium", "pyarrow", "fastparquet"),
#   envname = "metro",
#   method = "conda",
#   pip = TRUE
# )
...
#| eval: false
# Install required packages
pip install duckdb matplotlib geopandas pandas shapely folium pathlib pyarrow fastparquet
```
...
# Read existing boundary data (example: Salt Lake County, UT)
slco_boundary = (
    gpd.read_file("data/SaltLakeCounty_Boundary.geojson")
    .to_crs("EPSG:4326")
)
...
slco_places_sf |>
  ...
  mapview::mapview(map.types = "CartoDB.Voyager")
```
